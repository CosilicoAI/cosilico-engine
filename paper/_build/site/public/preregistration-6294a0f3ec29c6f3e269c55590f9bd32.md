...
1. **Unit tests**: Individual cases with known expected values
2. **Aggregate microsimulation**: Sum across CPS microdata must match within tolerance
3. **Cross-oracle**: PolicyEngine and TAXSIM agreement where coverage overlaps
